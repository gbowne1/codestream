...
async function captureScreen() {
    ...
    try {
        ...
        if (err.name === 'NotAllowedError') {
            updateStatus('Permission denied. Please allow screen sharing.', 'warning');
            streamStats.textContent = 'Click "Share Screen" and select a screen to share';
            ...
            updateStatus(`Screen capture failed: ${err.message || err.name}`, 'danger');
        }
    }
}
...
async function captureCamera() {
    ...
    try {
        ...
        // Provide specific error messages
        if (err.name === 'NotAllowedError') {
            updateStatus('Camera permission denied. Check browser settings.', 'warning');
            ...
            updateStatus(`Camera access failed: ${err.message || err.name}`, 'danger');
        }
    }
}
